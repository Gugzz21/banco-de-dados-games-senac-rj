...
public class JogoController {
    ...
    @Operation(summary = "Listar jogo pelo id de jogo", description = "Endpoint para jogo pelo id de jogo")
    ...
    @Operation(summary = "Apagar registro de jogo", description = "Endpoint para apagar um jogo pelo Id")
